...
\CzechAbstract{Tato bakalářská práce se zabývá implementací nástroje pro označování objektů a obrazových dat ve webovém prostředí za pomoci knihovny React. Označená data se stanou vstupem pro budoucí analýzu.}

\CzechKeywords{React, LIDAR, WebGL, bakalářská práce}

\EnglishAbstract{This bachelor thesis deals with implementation of tool for object selection and data visualization in web browser with using of React library. Selected data will become input data for future analyzation.}

\EnglishKeywords{React, LIDAR, WebGL, bachelor thesis}
...
\AddAcronym{JSX}{JavaScript eXtension}
...
\lstinputlisting[language=python,caption=Základní nastavení django serveru.]{SourceCodes/basicDjango.py}
...
%todo má cenu v téhle sekci pokračovat?
...
\lstinputlisting[language=JavaScript,caption=Vytváření kamery pro sledování selekce.]{SourceCodes/additionalCamera.js} 
...
%todo remake this from python
\lstinputlisting[language=python,caption=Ukládání obrazu selekce.]{SourceCodes/storingImages.py}
